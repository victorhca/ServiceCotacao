# ServiceCotacao serviço que fica instalado no SO, responsável por monitorar uma tabela com dados de moedas origens, moedas destinos e valores e realizar a conversão.
